...
//    public final static String REQUEST_URL = "http://continuelibrary.mzalive.org/server/index.php";
    public final static String REQUEST_URL = "http://104.131.201.90/continue_lib/index.php";
//    public final static String REQUEST_URL = "http://192.168.56.1/Continue/server/index.php";
