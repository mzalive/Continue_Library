...
function foo($target){
	...
	$book_imageurl = $_POST[$target+"_imageurl"];
	...
	.$target."_isbn='$book_isbn', ".$target."_publiser='$book_publisher', ".$target."_imageurl='$book_imageurl', "
	.$target."_summary='$book_summary', ".$target."_publish_date='$book_publish_date', ".$sql_addition."where "
	.$target."_id='$book_id'";
